...
{
    public class DogProductController : Controller
    {
        private readonly WaggyContext _waggyContext;

        public DogProductController(WaggyContext waggyContext)
        {
        ...
        {
            var value = _waggyContext.ProductView.Where(x=>x.CategoryId==1).ToList();
            return View(value);
        }
        public IActionResult AddDogProduct()
        {
            var values = _waggyContext.Categories.Where(x => x.CategoryId == 1).ToList();
        ...
        [HttpPost]
        public IActionResult AddDogProduct(ProductModel model)
        {
        ...
        [HttpGet]
        public IActionResult UpdateDogProduct(int id)
        {
      ...
      _waggyContext.Categories.Where(x => x.CategoryId == 1),
      "CategoryId",
      "CategoryName"
  );
        ...
        public IActionResult UpdateDogProduct(int id, ProductModel model, IFormFile ProductImageUrl)
        {
